...
public class ExportItemStackNBTCommand extends NBTExporterCommand {
    ...
    public static void register(CommandDispatcher<FabricClientCommandSource> dispatcher) {
        dispatcher.register(literal("exportnbt")
                            .executes(context -> {
    ...
    private static String getFilename(CommandContext<FabricClientCommandSource> context)
    ...
    private static int execute(CommandContext<FabricClientCommandSource> context, String filename)
    throws CommandSyntaxException {
        ...
        try {
            ...
            context.getSource().sendFeedback(Component.translatable("commands.nbtexporter.exportnbt.success",
